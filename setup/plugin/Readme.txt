...
SimpleSC::StopService [name_of_service] [wait_for_file_release]
...
; Stop a service and waits for file release
  SimpleSC::StopService "MyService" 1
  Pop $0 ; returns an errorcode (<>0) otherwise success (0)

; Stops two services and waits for file release after the last service is stopped
  SimpleSC::StopService "MyService1" 0
  Pop $0 ; returns an errorcode (<>0) otherwise success (0)
  SimpleSC::StopService "MyService2" 1
  Pop $0 ; returns an errorcode (<>0) otherwise success (0)
